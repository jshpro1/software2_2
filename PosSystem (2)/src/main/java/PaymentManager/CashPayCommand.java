...
public class CashPayCommand implements Command{
    ...
    public CashPayCommand(Scanner scanner) {
    ...
    public void execute() {
        ...
        // Payment process with cash payment goes here...
        // Calculate change

        int change = receivedAmount - amount;
        ...
        savePaymentInfo(paymentNumber,"현금결제", amount);
    }
