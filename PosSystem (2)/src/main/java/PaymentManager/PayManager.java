...
public class PayManager {
    ...
    public PayManager() {
        ...
        commands.put("card", new CardPayCommand(scanner));
        commands.put("cash", new CashPayCommand(scanner));
        commands.put("mobile", new MobilePayCommand(scanner));
        commands.put("receipt", new ReceiptPrintCommand(menus, scanner));
    }
